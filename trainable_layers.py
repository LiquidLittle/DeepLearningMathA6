...
def define_dense_model_with_hidden_layers(input_length, 
    ...
    model = keras.Sequential([
        layers.Dense(hidden_layers_sizes[0],activation=activation_func_array[0],input_shape=(input_length,)),
        layers.Dense(hidden_layers_sizes[1],activation=activation_func_array[1], input_shape=(hidden_layers_sizes[0],)),
        layers.Dense(output_length,activation=output_function, input_shape=(hidden_layers_sizes[1],))
    ])
    return model
